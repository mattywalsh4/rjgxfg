...
namespace science_game
{
    public partial class hard : Form
    {
        ...
        int num = 0;
        //Arrays
        string[] Symbols = { "Calcium", "Hassium", "Iron", "Osmium", "Platinum", "Rhodium", "Thorium", "Zinc", "Mercury", "Lutetium", "Ca", "Hs", "Fe", "Os", "Pt", "Rh", "Th", "Zn", "Hg", "Lu" };
        string[] Science = { "Ca", "Hs", "Fe", "Os", "Pt", "Rh", "Th", "Zn", "Hg", "Lu", "Calcium", "Hassium", "Iron", "Osmium", "Platinum", "Rhodium", "Thorium", "Zinc", "Mercury", "Lutetium" };
